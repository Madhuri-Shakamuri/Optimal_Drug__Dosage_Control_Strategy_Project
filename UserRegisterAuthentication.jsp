...
.style29 {font-size: 16px; color: #CC33FF; }
.style5 {	color: #66CCFF;
	font-size: 21px;
	font-weight: bold;
}
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style24"> User Registration Status </h2>
           <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          ...
          <div>
            <div>
              ...
              <p class="style18">&nbsp;</p>
              <p class="style18 style32">User Name Already Exist.</p>
              <p class="style18 style22">&nbsp;</p>
              <p align="left"><a href="UserRegister.jsp" class="style16">Back</a><a href="UserRegister.jsp" class="style5 style14 style17"></a></p>
              <%
...
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,status,image) values(?,?,?,?,?,?,?,?,?)");
						...
						{
						%>
              <p class="style29 style32">Registration Successfull.</p>
              <p class="style19">&nbsp;</p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="UserRegisterAuthentication.jsp">Home</a></li>
